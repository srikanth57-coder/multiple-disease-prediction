...
if (selected == 'Diabetes Prediction'):
    ...
    if st.button('diabetes final results'):
        predict=loaded_model([Pregnancies,Glucose,BloodPressure,SkinThickness,Insulin,BMI,DiabetesPedigreeFunction,Age])
        if predict==0:
...
if (selected == 'Heart Disease Prediction'):
    ...
    if st.button('heart disease final results'):
        heart_predict=loaded_model([Pregnancies,Glucose,BloodPressure,SkinThickness,Insulin,BMI,DiabetesPedigreeFunction,Age])
        if heart_predict==0:
